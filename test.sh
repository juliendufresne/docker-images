...
if [[ -v TRAVIS ]]; then
    docker build --tag "$DOCKER_ORGANIZATION/$DOCKER_IMAGE:$DOCKER_IMAGE_TAG" --cache-from "$DOCKER_ORGANIZATION/$DOCKER_IMAGE" $DOCKER_IMAGE/$DOCKER_IMAGE_TAG
else
    docker build --tag "$DOCKER_ORGANIZATION/$DOCKER_IMAGE:$DOCKER_IMAGE_TAG" $DOCKER_IMAGE/$DOCKER_IMAGE_TAG
fi
